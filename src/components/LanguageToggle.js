...
export default function LanguageToggle() {
  ...
  return (
    <div
      ...
      className="d d-p d-bw z-40 flex items-center justify-between rounded-full border border-white/55 bg-white/25 backdrop-blur-sm max-lg:fixed max-lg:bottom-6 max-lg:right-6 max-lg:h-11 max-lg:w-24 max-lg:border max-lg:p-1 max-lg:text-base"
    >
      <button
        type="button"
